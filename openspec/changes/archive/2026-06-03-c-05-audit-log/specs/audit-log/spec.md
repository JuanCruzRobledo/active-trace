...
## Purpose
Define el sistema de auditoría append-only que persiste en base de datos todas las acciones significativas del sistema, con consultas filtrables y códigos de acción estandarizados. Es la fuente de verdad para trazabilidad y reemplaza el logger JSON actual.
