...
# Códigos C-15 (avisos)
# Códigos C-18 (liquidaciones y facturas)
ACCION_FACTURA_ABONAR = "FACTURA_ABONAR"

ACCION_AVISO_CREAR = "AVISO_CREAR"
ACCION_AVISO_MODIFICAR = "AVISO_EDITAR"
ACCION_AVISO_ELIMINAR = "AVISO_ELIMINAR"
ACCION_AVISO_ACK = "AVISO_ACK"

# Códigos C-20 (perfil y mensajería interna)
ACCION_PERFIL_EDITAR = "PERFIL_EDITAR"
ACCION_MENSAJE_ENVIAR = "MENSAJE_ENVIAR"

# Códigos C-16 (tareas internas)
ACCION_TAREA_CREAR = "TAREA_CREAR"
ACCION_TAREA_ESTADO_CAMBIAR = "TAREA_ESTADO_CAMBIAR"
ACCION_TAREA_COMENTARIO = "TAREA_COMENTARIO"

# Códigos C-17 (programas y fechas academicas)
ACCION_PROGRAMA_SUBIR = "PROGRAMA_SUBIR"
ACCION_PROGRAMA_ELIMINAR = "PROGRAMA_ELIMINAR"
ACCION_FECHA_ACADEMICA_CREAR = "FECHA_ACADEMICA_CREAR"
ACCION_FECHA_ACADEMICA_MODIFICAR = "FECHA_ACADEMICA_MODIFICAR"
ACCION_FECHA_ACADEMICA_ELIMINAR = "FECHA_ACADEMICA_ELIMINAR"

# Códigos C-14 (coloquios/evaluaciones)
...
VALID_ACCION_CODES: frozenset[str] = frozenset({
    ...
    ACCION_AVISO_ACK,
    ACCION_PERFIL_EDITAR,
    ACCION_MENSAJE_ENVIAR,
    ACCION_TAREA_CREAR,
    ACCION_TAREA_ESTADO_CAMBIAR,
    ACCION_TAREA_COMENTARIO,
    ACCION_COLOQUIO_CREAR,
    ACCION_COLOQUIO_IMPORTAR,
    ACCION_COLOQUIO_RESERVAR,
    ACCION_COLOQUIO_CANCELAR,
    ACCION_COLOQUIO_RESULTADO,
    ACCION_COLOQUIO_CERRAR,
    ACCION_FACTURA_ABONAR,
